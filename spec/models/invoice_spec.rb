...
RSpec.describe Invoice, type: :model do
  ...
  describe "instance methods" do 
    ...
    describe 'total_revenue' do
      it 'returns total revenue of invoice regardless of transaction status' do
        merchant_1 = create(:merchant)
        merchant_2 = create(:merchant)
    ...
    describe 'total_discounted_revenue' do
      it 'returns total discounted revenue of invoice' do
        merchant_1 = create(:merchant)
        merchant_2 = create(:merchant)
        ...
        expect(invoice_1.total_discounted_revenue).to eq(4500)
        expect(invoice_2.total_discounted_revenue).to eq(1372.5)
      end
    end
  end
end
